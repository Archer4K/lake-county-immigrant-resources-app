...
function localReply(message: string, resources: Resource[], language: string) {
  ...
  const text = language === "हिन्दी" ? "AI सहायता अभी उपलब्ध नहीं है। ये संसाधन मदद कर सकते हैं। संस्था से जानकारी की पुष्टि करें या 211 पर कॉल करें।" : language === "Español"
